...
function PredictedLocVsMigrant() {
  ...
  return (
    <div className="full-width-height container">
      <h1 className="no-margin center" style={{ marginBottom: ".5em" }}>
        Predicted Migration Inflow Pattern
      </h1>
...
export default PredictedLocVsMigrant;
